...
exports.GrammarCompilerNode = GrammarCompilerNode;
...
class AbstractGrammarDefinitionNode extends TreeNode_1.default {
    getFirstWordMap() {
        ...
        map[GrammarConstants_1.GrammarConstants.constants] = GrammarConstantsNode;
        map[GrammarConstants_1.GrammarConstants.compilerNodeType] = GrammarCompilerNode;
        map[GrammarConstants_1.GrammarConstants.constructors] = GrammarCustomConstructorsNode;
