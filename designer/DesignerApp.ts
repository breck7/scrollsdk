...
class headerComponent extends AbstractTreeComponent {
 ...
 div
  ...
  p Click "Newlang" to create a New Language, or explore/edit existing languages. In dev tools, you can access the parsed trees below as "app.grammarProgram" and program at "app.program". We also have a work-in-progress <a href="https://github.com/breck7/jtree/blob/main/languageChecklist.md">checklist for creating new Tree Languages</a>.`
  }
}
