...
class Fusion implements Storage {
  ...
  private static _combineParsers(filePaths: string[], fileContents: string[], baseParsersCode = "") {
  ...
  private async _getLoadedFile(absolutePath, fusionFileClass = this.defaultFileClass) {
