...
Then we start by describing the problem and introducing the solution: a new family of programming languages that geometrically align source code with abstract syntax trees. Then we make some predictions. Finally, we end with a joke. If the paper is wrong, maybe you'll at least like the joke.
...
\begin{lstlisting}
ty aaaabbccccdddefggggjjjjjklllmmmmnopprsssz
