...
interface childShouldUpdateResult {
  child: AbstractParticleComponentParser
...
abstract class AbstractParticleComponentParser extends ParserBackedNode {
 ...
 class ${this.getCssClassNames().join(" ")}`
  ...
  protected _hasChildrenParticleComponents() {
...
${new stumpParser(this.toStumpCode()).compile()}
  ...
  protected _getParticleComponentsThatNeedRendering(arr: childShouldUpdateResult[]) {
    this._getChildParticleComponents().forEach((child: AbstractParticleComponentParser) => {
