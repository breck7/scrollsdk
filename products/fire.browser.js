...
numberIdentifierAtom identifierAtom
hashBangAtom
 paint comment
hashBangKeywordAtom
 paint comment
stringAtom
 paint string
booleanIdentifierAtom identifierAtom
functionIdentifierAtom identifierAtom
identifiersAtom identifierAtom
instanceIdentifierAtom identifierAtom
methodIdentifierAtom identifierAtom
resultIdentifierAtom identifierAtom
cueAtom
 paint keyword
stringIdentifierAtom identifierAtom
stringAtomsAtom stringAtom
leftNumberAtom numberAtom
leftAnyAtom anyAtom
...
abstractNonTerminalParser
 ...
 atoms cueAtom
abstractJsblockParser abstractNonTerminalParser
 compiler
  openSubparticles  {
  closeSubparticles }
blockParser abstractJsblockParser
 description block of code
 popularity .2
 compiler
  stringTemplate /* {identifierAtom} */
 cue block
functionParser abstractJsblockParser
 cue function
 ...
 popularity .1
ifParser abstractJsblockParser
 cue if
 description If tile
...
whileParser abstractJsblockParser
 cue while
...
abstractTerminalParser
 atoms cueAtom
abstractAssignmentParser abstractTerminalParser
abstractArithmeticParser abstractAssignmentParser
 atoms cueAtom identifierAtom
 catchAllAtomType anyAtom
 compiler
  stringTemplate const {identifierAtom} = {anyAtom}
 popularity .2
divideParser abstractArithmeticParser
 description Divide Numbers
 compiler
  catchAllAtomDelimiter  / 
 cue divide
moduloParser abstractArithmeticParser
 description Modulo Numbers
 compiler
  catchAllAtomDelimiter %
 cue modulo
multiplyParser abstractArithmeticParser
 description Multiply Numbers
 compiler
  catchAllAtomDelimiter  * 
 cue multiply
substractParser abstractArithmeticParser
 description Subtract Numbers
 compiler
  catchAllAtomDelimiter  - 
 cue substract
addParser abstractArithmeticParser
 cue add
 example
  add ten 2 3 5
 ...
 compiler
  catchAllAtomDelimiter  + 
abstractBooleanOperatorParser abstractAssignmentParser
 description Runs a boolean test and saves result.
greaterThanParser abstractBooleanOperatorParser
 ...
 popularity .1
 cue greaterThan
greaterThanOrEqualParser abstractBooleanOperatorParser
...
lessThanParser abstractBooleanOperatorParser
 ...
 popularity .1
 cue lessThan
lessThanOrEqualParser abstractBooleanOperatorParser
 cue lessThanOrEqual
 ...
 compiler
  stringTemplate const {identifierAtom} = {leftAnyAtom} <= {anyAtom}
 popularity .1
sumParser abstractAssignmentParser
 cue sum
 description Add numbers and store result
 ...
 compiler
  ...
  catchAllAtomDelimiter , 
 popularity .1
booleanParser abstractAssignmentParser
 cue boolean
...
callFunctionAndSetParser abstractAssignmentParser
 ...
 compiler
  ...
  catchAllAtomDelimiter , 
callMethodAndSetParser abstractAssignmentParser
 ...
 compiler
  ...
  catchAllAtomDelimiter , 
joinParser abstractAssignmentParser
 cue join
...
numberParser abstractAssignmentParser
 ...
 popularity .3
numbersParser abstractAssignmentParser
 cue numbers
 ...
 compiler
  stringTemplate const {identifierAtom} = [{numberAtom}]
  catchAllAtomDelimiter , 
stringParser abstractAssignmentParser
 cue string
 ...
 popularity .2
callFunctionParser abstractTerminalParser
 cue callFunction
 ...
 compiler
  ...
  catchAllAtomDelimiter , 
decrementParser abstractTerminalParser
 cue decrement
 ...
 popularity .1
dumpIdentifierParser abstractTerminalParser
 cue dumpIdentifier
 ...
 compiler
  ...
  catchAllAtomDelimiter , 
 popularity .5
exportParser abstractTerminalParser
 cue export
 ...
 popularity .1
incrementParser abstractTerminalParser
 cue increment
...
requireParser abstractTerminalParser
 ...
 popularity .1
returnParser abstractTerminalParser
 cue return
